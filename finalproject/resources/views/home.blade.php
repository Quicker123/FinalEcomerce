...
@section('contents')
	...
	<section class="hero-slider" >
		...
		<div class="single-slider">
			<div class="row">
				<img src="/storage/images/highresolution.jpg">
			</div>
			<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="single-banner">
						<img src="/storage/images/shoes.jpg" alt="#">
						<div class="content">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-12">
					<div class="single-banner">
						<img src="/storage/images/camera.jpg" alt="#">
						<div class="content">
							<p>Man's Collectons</p>
                ...
                <div class="col-12">
                    <div class="owl-carousel popular-slider">
						...
						<div class="single-product">
							<div class="product-img">
								<a href="product-details.html">
									<img class="default-img" src="/storage/images/cameraset.jpg" alt="#">
									<img class="hover-img" src="/storage/images/cameraset.jpg" alt="#">
									<span class="out-of-stock">Hot</span>
								</a>
								<div class="button-head">
									<div class="product-action">
						...
						<div class="single-product">
                            <div class="product-img">
                                <a href="product-details.html">
                                    <img class="default-img" src="/storage/images/elovera.jpg" alt="#">
                                    <img class="hover-img" src="/storage/images/elovera.jpg" alt="#">
									<span class="new">New</span>
                                </a>
								<div class="button-head">
									<div class="product-action">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-6 col-12 padding-right">
						<div class="image">
							<img src="/storage/images/headset.jpg" alt="#">
						</div>	
					</div>	
